...
if not st.session_state.news_selected:
    ...
    with col_settings:
        with st.form("generate_episode_form"):
            ...
            model_name = st.selectbox("Select LLM Model:", options=["openai/gpt-oss-120b", "openai/gpt-oss-20b", "qwen/qwen3.6-27b"], index=None, help="Choose the large language model for dialogue generation.")
